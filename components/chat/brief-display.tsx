...
export function BriefDisplay({ brief }: BriefDisplayProps) {
    ...
    return (
        <Card className="mt-6 w-full max-w-full overflow-visible border-0 shadow-xl bg-white rounded-xl ring-1 ring-stone-200/50 p-0 gap-0 dark:bg-zinc-900 dark:ring-zinc-800/50">
            {/* Dark Header */}
            <div className="bg-black text-white p-5 flex items-start justify-between dark:bg-zinc-950 dark:text-zinc-100">
                <div className="space-y-1.5">
                    ...
                    <p className="text-stone-400 text-xs pl-7 dark:text-zinc-500">
                        Breif sent to Desingers portal for review.
                    </p>
                </div>
                <Button
                    variant="outline"
            ...
            <CardContent className="p-0 relative bg-white dark:bg-zinc-900 overflow-y-auto">
                <AnimatePresence mode="wait">
                    {!showJson ? (
                        ...
                        >
                            ...
                            <div className="max-h-[60vh] w-full overflow-y-auto bg-stone-50/30 dark:bg-zinc-950/30 custom-scrollbar">
                                <div className="p-6">
